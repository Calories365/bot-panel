        ...
        $response = $this->client->post('https://api.openai.com/v1/chat/completions', [
            ...
            'json' => [
                ...
                'messages' => [
                    [
                        'role' => 'user',
                        'content' => "Есть продукт: \"$text\". Выведи КБЖУ (Калории, Белки, Жиры, Углеводы) на 100 грамм продукта. Если информация о продукте отсутствует или продукт неизвестен или вместо слово не является продуктом
                        , выведи: 'Информация о продукте недоступна'. Формат вывода должен строго соответствовать следующему примеру, где после каждого параметра стоит точка с запятой:
...
Входной текст: 'Сегодня ничего не ел.' Информация о продукте недоступна."
                    ]
                ]
            ]
        ]);
