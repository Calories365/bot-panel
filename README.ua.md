...
## [Спробуйте Щоденник Калорій зараз!](https://calculator.calories365.online)
...
* Автентифікація через **OAuth** (Google). Проєкт тимчасово працює на домені .online замість .com. У зв’язку з цим OAuth-аутентифікація тимчасово недоступна.
