...
переведи это пожалуйста на анг и укр и выведи языковые фразы для языков
EOT,
    'menu'             => 'Меню',
    ...
    'whole_day' => 'Весь день',
    'send_feedback_email' => 'Вы можете отправить свой отзыв на почту: mostlysunny1488@gmail.com',
];
