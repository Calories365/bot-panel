...
return [
    ...
    */
    ...
    'failed_to_get_product_data'=> 'Не удалось получить данные продукта.',
    ...
    'seems_you_are_new'    => 'Похоже, вы здесь впервые. Чтобы связать аккаунт, используйте ссылку «Подключить» из личного кабинета (https://calculator.calories365.com).',
    ...
    'subscription_required_message' => "Лимит запросов исчерпан, чтобы сохранять приемы пищи без ограничений - купите перемиум в личном кабинете (https://calculator.calories365.com)",
...
4)Статистика за день: Напишите команду /stats, чтобы увидеть статистику за день.

Ссылка на приложение: https://calculator.calories365.com
