...
2. Вхідний текст: '100 грамів картоплі, помідор і курка221.'
   Очікуваний вивід:
   Картопля - 100 грамів;
   Помідор - 120 грамів;
   Курка221 - 200 грамів;

3. Вхідний текст: '100 грамів картоплі, помідор і курка два два один.'
   Очікуваний вивід:
   Картопля - 100 грамів;
   Помідор - 120 грамів;
   Курка два два один - 200 грамів;

4. Вхідний текст: 'варениу картопелю'
   Очікуваний вивід:
   Картопель варений - 200 грамів;

5. Вхідний текст: 'нічого'
   Очікуваний вивід:
   продуктів немає

6. Вхідний текст: 'два яйця'
   Очікуваний висновок:
   Яйце - 120 грамів;

7. Вхідний текст: "дві цукерки"
   Очікуваний вивід:
   Цукерка – 20 грамів;

8. Вхідний текст: "нуль п'ять пива
   Очікуваний вивід:
   Пиво – 500 грамів;
EOT,
